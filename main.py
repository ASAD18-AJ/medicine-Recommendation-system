...
symptom_options = [
    {
        'value': symptom,
        'label': ' '.join(symptom.replace('_', ' ').split()).title()
    }
...
def home():
    if request.method == 'POST':
        ...
        if not selected_symptoms:
            ...
            return render_template('index.html', message=message, symptom_options=symptom_options)
        else:
            user_symptoms = [symptom.strip() for symptom in selected_symptoms if symptom.strip()]
            ...
            return render_template('index.html', predicted_disease=predicted_disease, dis_des=dis_des,
                                   ...
                                   workout=workout, symptom_options=symptom_options)
